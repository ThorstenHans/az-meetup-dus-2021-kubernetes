...
rgName="rg-azdus-"$initials
location="westeurope"
acrName="azdus2021"$initials
sqlServerName="azdus2021"$initials
aksName="azdus-2021-"$initials
...
az sql server create -n $sqlServerName -l $location -g $rgName --admin-user azdus2021 --admin-password LoremIpsum@2021
